...
import {
  Plus, Search, MoreVertical, Trash2, Edit, AlertTriangle, X
} from "lucide-react";
...
export default function InventoryPage() {
  ...
  const handleEditClick = (item: typeof products extends (infer T)[] | undefined ? T : never) => {
    setEditingProduct({
      id: item.id,
      name: item.name,
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage stock, prices, and SKUs.</p>
        </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="APP-1001" {...field} value={field.value ?? ""} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
      ...
      <div className="rounded-md border bg-white shadow-sm">
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              <TableRow><TableCell colSpan={5} className="h-24 text-center text-slate-500">Loading inventory...</TableCell></TableRow>
                  ...
                  <TableCell>
                    {item.quantity < 5 ? (
                      <span className="inline-flex items-center gap-1 text-red-600 font-medium text-xs bg-red-50 px-2 py-1 rounded-full">
                        <AlertTriangle className="h-3 w-3" /> Low: {item.quantity}
                      </span>
                    ) : (
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem className="text-red-600" onClick={() => deleteMutation.mutate({ id: item.id })}>
